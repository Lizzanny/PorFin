...
class InvDpreCtaCont extends ConexionOracle{
	...
	*{
	...
	for ($i = 0; $i < $this->tamCuent; $i++) { 
		$this->html.='
					<tr id="tdh">
						<th>'.$this->infCuent[$i]['cvecta'].'</th>
						<th colspan="5">'.$this->infCuent[$i]['nomcta'].'</th>
					</tr>';
 ...
 $this->html.='</tbody>
	...
	$ob->MetodoDeAccesoParaIniciar(101,'2019-05-01', '2019-06-01');//$_REQUEST['ct'],  $_REQUEST['fi'], $_REQUEST['ff']);
