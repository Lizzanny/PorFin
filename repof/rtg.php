        ...
        <div id="content" style="margin-top: 6%; margin-left:0; width: 100%; ">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <h3 class="text-center text-uppercase">Reporte por tipo de gasto</h3>
                </div>
            </div>
            <iframe src="http://172.30.10.94:8080/birt-viewer/frameset?__report=report/sicop-conac/repcontablepres02.rptdesign" height="800px" width="100%"></iframe>
