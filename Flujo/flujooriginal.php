...
<div class="row">
 ...
 <!-- <img src="images/Liconsa.png" class="img-responsive" alt="Imagen responsive"  width=""366"" height="144">!-->
  <img src="http://localhost:8080/SICOPLOCAL/publico/img/logoliconsasader.jpg" class="img-responsive" alt="Imagen responsive"  width=""366"" height="64">
</div>
...
<div style="margin-top:15px; margin-bottom:15px;">
	  			<marquee>
					<h3 align="center" style="font-size:165%;"><font color="red">FLUJO DE EFECTIVO </font></h3>
				</marquee>
			</div>
...
<div id="example">
    ...
    <script>
       ...
       var dataSource = new kendo.data.DataSource({
						 transport: {
                        read: "http://localhost:8080/SICOPLOCAL/Flujo/Data/conceptos2.php?mesdesde="+mes+"&axo="+axo,
						 create: {
							url: "",
							type: "POST"
						},
						update: {
                                 url: "http://localhost:8080/SICOPLOCAL/Flujo/data/actualiza.php",
                                 type: "POST"
                                },
						destroy: {
                                 url: "",
