...
if (!defined('TTF_DIR')) {
    if (strstr( PHP_OS, 'WIN') ) {
       ...
       // define('TTF_DIR','/usr/share/fonts/truetype/'); verdadera
        define('TTF_DIR',' /home/desarrollo/web/sigehi.liconsa.gob.mx/public_html/reporte_mpdf/publico/mpdf/JpGraph/fonts/arial.ttf');
