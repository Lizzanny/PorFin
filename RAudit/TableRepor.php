...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content" style="margin-top: 10%; margin-left:0; width: 100%;">
            ...
            <div class="row">
                <div id="cuadro1" class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                ...
                <div id="cuadro1" class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                    <div class="tablita table-responsive col-xs-12 col-sm-12 col-md-12 col-lg-12" >      
                        <table id="datos" class="table table-bordered table-condensed" width="100%">
                            <thead>
                                <tr>                
                                    <th>ct0</th>
                                    <th>ct1</th>
